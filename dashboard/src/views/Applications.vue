...
import MetadataEditor, {
  type EditableMetadata as EditableMetadataItem,
} from "@/components/application/MetadataEditor.vue";
                ...
                >
                  ...
                  <div class="flex shrink-0 gap-2 sm:justify-end">
                    <Button
                      size="sm"
                      variant="outline"
                      @click="isComposeEditorOpen = true"
                    >
    ...
    <Dialog v-model:open="isComposeEditorOpen">
      ...
      >
        ...
        <div class="flex-1 overflow-hidden">
          <YamlEditor
            v-model="formData.dockerCompose"
            :height="'100%'"
