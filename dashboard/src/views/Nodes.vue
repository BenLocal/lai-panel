      ...
      if (index !== -1) {
        ...
        if (existingNode) {
          nodes.value[index] = {
            ...
            created_at: existingNode.created_at,
            updated_at: existingNode.updated_at,
          };
        }
      }
    } else {
...
<template>
  <div class="space-y-6">
    ...
    <div
      v-if="error"
      class="rounded-lg border border-red-500/20 bg-red-500/10 p-4 text-red-500"
    >
      {{ error }}
    </div>
    ...
    <Sheet v-model:open="isSheetOpen">
      <SheetContent class="px-6 py-6">
        ...
        <div class="space-y-4 !px-0">
          ...
          <div class="space-y-2">
            <label for="node-display-name" class="text-sm font-medium"
              >Display Name</label
            >
            <Input
          ...
          <div class="space-y-2">
            <label for="node-address" class="text-sm font-medium"
              >Address *</label
            >
            <Input
              id="node-address"
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-2">
              <label for="node-ssh-port" class="text-sm font-medium"
                >SSH Port</label
              >
              <Input
                id="node-ssh-port"
            ...
            <div class="space-y-2">
              <label for="node-agent-port" class="text-sm font-medium"
                >Agent Port</label
              >
              <Input
                id="node-agent-port"
                v-model.number="formData.agent_port"
                type="number"
                placeholder="8080"
              />
            </div>
          ...
          <div class="space-y-2">
            <label for="node-ssh-user" class="text-sm font-medium"
              >SSH User</label
            >
            <Input
              id="node-ssh-user"
          ...
          <div class="space-y-2">
            <label for="node-ssh-password" class="text-sm font-medium"
              >SSH Password</label
            >
            <Input
