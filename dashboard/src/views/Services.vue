                    ...
                    <div class="px-3 sm:px-5 py-6">
                        <Stepper v-model="currentStep" class="flex w-full items-start gap-2">
                            ...
                            <StepperItem v-slot="{ state }"
                                class="relative flex w-full flex-col items-center justify-center" :step="1">
                                <StepperSeparator
                            ...
                            <StepperItem v-slot="{ state }"
                                class="relative flex w-full flex-col items-center justify-center" :step="2">
                                <StepperSeparator
                                    class="absolute left-[calc(50%+20px)] right-[calc(-50%+10px)] top-5 block h-0.5 shrink-0 rounded-full bg-muted group-data-[state=completed]:bg-primary" />
                                <StepperTrigger as-child>
                                    <Button :variant="state === 'completed' || state === 'active'
                            ...
                            <!-- Step 3: Select Node -->
                            <StepperItem v-slot="{ state }"
                                class="relative flex w-full flex-col items-center justify-center" :step="3">
                                <StepperTrigger as-child>
                                    <Button :variant="state === 'completed' || state === 'active'
                                        ? 'default'
                                        : 'outline'
                        ...
                        <div class="mt-8 space-y-4">
                            ...
                            <div v-if="currentStep === 1" class="space-y-4">
                                <div class="space-y-2">
                                    ...
                                    <Input id="server-name-input" v-model="serverName"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Select v-else id="deploy-app-select"
                                        :model-value="selectedApplication?.id?.toString()" @update:model-value="
                                        ...
                                        <SelectContent>
                                            <SelectItem v-for="app in applications" :key="app.id"
                            ...
                            <div v-if="currentStep === 2" class="space-y-4">
                                ...
                                <div v-else class="space-y-4">
                                    <div v-for="item in selectedApplication?.qa || []" :key="item.name"
                                        class="space-y-2">
                                        ...
                                        <!-- Text Input -->
                                        <Input v-if="item.type === 'text'" :id="`qa-${item.name}`"
                                        ...
                                        <!-- Select -->
                                        <Select v-else-if="item.type === 'select'" :model-value="getQAValue(item.name)"
                                            @update:model-value="
                                                (val: any) =>
                                            ...
                                            <SelectContent>
                                                <SelectItem v-for="option in item.options || []" :key="option"
                                                    :value="option">
                                                    {{ option }}
                                                </SelectItem>
                                            </SelectContent>
                            ...
                            <div v-if="currentStep === 3" class="space-y-4">
                                <div class="space-y-2">
                                    ...
                                    <Select v-else id="deploy-node-select" :model-value="selectedNode?.id?.toString()"
                                        ...
                                        <SelectContent>
                                            <SelectItem v-for="node in nodes" :key="node.id"
